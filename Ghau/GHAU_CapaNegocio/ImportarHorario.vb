...
2:
        ...
        If dt_Choques.Rows.Count > 0 Then 'dterrores.Rows.Count > 0 Then

            Dim vista As New DataView(dt_Choques)
            Dim dtsindupl As DataTable = vista.ToTable(True, "NRC", "Descripcion")

            ingreso_Error_Excel(dtsindupl) 'dterrores)
        End If

        Return dataTable
    End Function
    Function ingreso_Error_Excel(ByVal dato As DataTable)
        Dim ingreso As New GHAU_CapaDatos.Agregar_evento
        'Dim variable As String = ""

        For i = 0 To dato.Rows.Count - 1
            ingreso.guardar_evento(dato)
        Next
